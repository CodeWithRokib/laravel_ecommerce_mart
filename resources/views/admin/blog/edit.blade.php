    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('blog.update', $blog->id) }}" method="PUT" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="" class="form-control">{{ $blog->description }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label ><input type="radio" name="status" value="2" {{ $blog->status == 2 ? 'checked' : '' }} > UnPublished</label>
                    </div>
                    <div class="form-group">
