        ...
        <div class="card-body card-block">
            <form action="{{ route('service.update', $service->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="validity" name="date"  value="{{ \Carbon\Carbon::parse($service->date)->format('m/d/Y') }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="image" class=" form-control-label">Service Image</label>
                    <input type="file" id="image" name="image" class="form-control">
                    <img src="{{ asset($service->image) }}" height="200px" width="200px" alt="">
                </div>
                <div class="form-group">
